package org.stuartresearch.purduelaundry;
 ...
 * more than a {@link LocationDetailFragment}.
 */
public class LocationDetailActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            String location = getIntent().getStringExtra(LocationDetailFragment.ARG_ITEM_ID);

            arguments.putString(LocationDetailFragment.ARG_ITEM_ID, location);
